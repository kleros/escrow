...
class Resume extends PureComponent {
  ...
  render() {
    const { createArbitrabletx, arbitrabletxForm, type, metaEvidenceIPFSHash } = this.props
                ...
                <a
                  href=
                    {`
                      ...
                      ?subject=Invoice ${encodeURIComponent(arbitrabletxForm.title)}
                      &body=Hi%2C%0A%0AHere%20is%20the%20link%20to%20the%20${encodeURIComponent(arbitrabletxForm.title)}%20invoice: ${shareLink}.%0A%0ABest%2C%0A
                    `}
                >
                  <Button
                  ...
                  document.queryCommandSupported('copy') && (
                    !copied ? (
                      <Button
                        ...
                        onClick={() => {navigator.clipboard.writeText(shareLink) && this.setState({copied: true})}}
                      >
